...
public class PlanController {
    ...
    @Operation(summary = "계획 목록 조회",
            ...
            responses = @ApiResponse(responseCode = "200", description = "조회 성공",
                    content = @Content(
                            schema = @Schema(implementation = PlanDto.ListResponse.class),
    ...
    @Operation(summary = "계획 상세 조회",
            description = """
                    ...
                    """,
            responses = @ApiResponse(responseCode = "200", description = "조회 성공",
                    content = @Content(schema = @Schema(implementation = PlanDto.DetailResponse.class))))
    ...
    public ResponseEntity<Void> createPlan(
            @io.swagger.v3.oas.annotations.parameters.RequestBody(
                    ...
                    required = true,
                    content = @Content(
                            schema = @Schema(implementation = PlanDto.CreateRequest.class),
                            examples = @ExampleObject(
                                    name = "계획 등록 요청 예시",
                                    value = """
                                            {
