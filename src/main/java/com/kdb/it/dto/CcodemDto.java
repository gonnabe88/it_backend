...
public class CcodemDto {
    ...
    @Setter
    @NoArgsConstructor
    @Schema(name = "CcodemDto.CreateRequest", description = "공통코드 생성 요청")
    ...
    @Setter
    @NoArgsConstructor
    @Schema(name = "CcodemDto.UpdateRequest", description = "공통코드 수정 요청")
    ...
    @Setter
    @Builder
    @Schema(name = "CcodemDto.Response", description = "공통코드 조회 응답")
