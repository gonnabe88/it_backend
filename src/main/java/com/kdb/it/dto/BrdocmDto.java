...
public class BrdocmDto {
    ...
    @AllArgsConstructor
    @Builder
    @Schema(name = "BrdocmCreateRequest", description = "요구사항 정의서 생성 요청")
    ...
    @AllArgsConstructor
    @Builder
    @Schema(name = "BrdocmUpdateRequest", description = "요구사항 정의서 수정 요청")
    ...
    @AllArgsConstructor
    @Builder
    @Schema(name = "BrdocmResponse", description = "요구사항 정의서 조회 응답")
