...
public class BgdocmDto {
    ...
    @AllArgsConstructor
    @Builder
    @Schema(name = "BgdocmCreateRequest", description = "가이드 문서 생성 요청")
    ...
    @AllArgsConstructor
    @Builder
    @Schema(name = "BgdocmUpdateRequest", description = "가이드 문서 수정 요청")
    ...
    @AllArgsConstructor
    @Builder
    @Schema(name = "BgdocmResponse", description = "가이드 문서 조회 응답")
