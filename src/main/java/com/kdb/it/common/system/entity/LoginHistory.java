 ...
 *
 * <p>
 * 주의: {@link com.kdb.it.domain.entity.BaseEntity}를 상속하지 않고 독립적인 엔티티로 설계됩니다.
 * (ID 자동 증가, 삭제 불필요 등의 특성)
 * </p>
 */
@Entity // JPA 엔티티로 등록
...
public class LoginHistory {
     ...
     */
    @Column(name = "LOGIN_TYPE", nullable = false, length = 80)
    private String loginType;

    /** IP 주소: 클라이언트의 실제 IP 주소 (프록시 환경 고려, 최대 200자) */
    @Column(name = "IP_ADDRESS", length = 200)
    private String ipAddress;

    /** User Agent: 클라이언트 브라우저/기기 정보 (최대 2000자) */
    ...
    /**
     * 실패 사유: 로그인 실패 시 실패 원인 메시지 (최대 2000자)
     ...
     *
     * <p>
     * 로그인 실패 시(비밀번호 불일치, 존재하지 않는 사번 등) 호출합니다.
     * </p>
     *
     ...
     */
    public static LoginHistory createLoginFailure(String eno, String ipAddress, String userAgent,
