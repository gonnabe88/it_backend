...
import com.kdb.it.service.BgdocmService;
...
public class BgdocmController {

    /** 가이드 문서 비즈니스 로직 서비스 */
    private final BgdocmService bgdocmService;
    ...
    public ResponseEntity<List<BgdocmDto.Response>> getDocuments() {
        return ResponseEntity.ok(bgdocmService.getDocumentList());
    }
    ...
    public ResponseEntity<BgdocmDto.Response> getDocument(@PathVariable("docMngNo") String docMngNo) {
        return ResponseEntity.ok(bgdocmService.getDocument(docMngNo));
    }
    ...
    public ResponseEntity<String> createDocument(@RequestBody BgdocmDto.CreateRequest request) {
        String docMngNo = bgdocmService.createDocument(request);
    ...
    public ResponseEntity<String> updateDocument(
            ...
            @RequestBody BgdocmDto.UpdateRequest request) {
        return ResponseEntity.ok(bgdocmService.updateDocument(docMngNo, request));
    }
    ...
    public ResponseEntity<Void> deleteDocument(@PathVariable("docMngNo") String docMngNo) {
        bgdocmService.deleteDocument(docMngNo);
