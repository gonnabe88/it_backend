...
import com.kdb.it.service.BrdocmService;
...
public class BrdocmController {

    /** 요구사항 정의서 비즈니스 로직 서비스 */
    private final BrdocmService brdocmService;
    ...
    public ResponseEntity<List<BrdocmDto.Response>> getDocuments() {
        return ResponseEntity.ok(brdocmService.getDocumentList());
    }
    ...
    public ResponseEntity<BrdocmDto.Response> getDocument(@PathVariable("docMngNo") String docMngNo) {
        return ResponseEntity.ok(brdocmService.getDocument(docMngNo));
    }
    ...
    public ResponseEntity<String> createDocument(@RequestBody BrdocmDto.CreateRequest request) {
        String docMngNo = brdocmService.createDocument(request);
    ...
    public ResponseEntity<String> updateDocument(
            ...
            @RequestBody BrdocmDto.UpdateRequest request) {
        return ResponseEntity.ok(brdocmService.updateDocument(docMngNo, request));
    }
    ...
    public ResponseEntity<Void> deleteDocument(@PathVariable("docMngNo") String docMngNo) {
        brdocmService.deleteDocument(docMngNo);
