...
import com.kdb.it.service.CfilemService;
...
public class CfilemController {

        /** 공통 첨부파일 비즈니스 로직 서비스 */
        private final CfilemService cfilemService;
        ...
        public ResponseEntity<List<CfilemDto.Response>> getFiles(
                        @ModelAttribute CfilemDto.SearchCondition condition) {
                return ResponseEntity.ok(cfilemService.getFiles(condition));
        }
        ...
        public ResponseEntity<CfilemDto.Response> getFile(
                        @PathVariable("flMngNo") String flMngNo) {
                return ResponseEntity.ok(cfilemService.getFile(flMngNo));
        }
        ...
        public ResponseEntity<CfilemDto.Response> uploadFile(
                ...
                CfilemDto.UploadRequest request = CfilemDto.UploadRequest.builder()
                                .flDtt(flDtt)
                                .orcPkVl(orcPkVl)
                                .orcDtt(orcDtt)
                                .build();
                ...
                CfilemDto.Response response = cfilemService.uploadFileAndGet(file, request);
        ...
        public ResponseEntity<CfilemDto.BulkUploadResponse> uploadFiles(
                ...
                return ResponseEntity.ok(cfilemService.uploadFiles(files, request));
        }
        ...
        public ResponseEntity<String> updateFileMeta(
                        @PathVariable("flMngNo") String flMngNo,
                        @org.springframework.web.bind.annotation.RequestBody CfilemDto.UpdateRequest request) {
                String updatedFlMngNo = cfilemService.updateFileMeta(flMngNo, request);
        ...
        public ResponseEntity<Void> deleteFile(@PathVariable("flMngNo") String flMngNo) {
                cfilemService.deleteFile(flMngNo);
        ...
        public ResponseEntity<Integer> deleteFilesByOrc(
                        @org.springframework.web.bind.annotation.RequestBody CfilemDto.BulkDeleteRequest request) {
                int deletedCount = cfilemService.deleteFilesByOrc(request.getOrcDtt(), request.getOrcPkVl());
        ...
        public ResponseEntity<org.springframework.core.io.Resource> downloadFile(
                ...
                CfilemService.CfilemDownloadResult result = cfilemService.downloadFile(flMngNo);
