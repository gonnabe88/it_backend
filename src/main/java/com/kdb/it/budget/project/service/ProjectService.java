 ...
 *
 * <p>
 * 정보화사업(TAAABB_BPROJM) 엔티티의 CRUD 및 품목({@link com.kdb.it.budget.project.entity.Bitemm})
 * 동기화
 * 비즈니스 로직을 처리합니다.
 * </p>
 *
...
public class ProjectService {
    ...
    private final com.kdb.it.budget.project.repository.ProjectItemRepository bitemmRepository;
     ...
     * 신청서 정보와 품목({@link com.kdb.it.budget.project.entity.Bitemm}) 목록을 포함합니다.
     * </p>
     *
    ...
    public ProjectDto.Response getProject(String prjMngNo) {
        ...
        List<com.kdb.it.budget.project.entity.Bitemm> bitemms = bitemmRepository.findByPrjMngNoAndPrjSnoAndDelYn(prjMngNo,
                project.getPrjSno(), "N");
    ...
    public String createProject(ProjectDto.CreateRequest request) {
        ...
        if (request.getItems() != null && !request.getItems().isEmpty()) {
            ...
            for (ProjectDto.BitemmDto itemDto : request.getItems()) {
                ...
                com.kdb.it.budget.project.entity.Bitemm newItem = com.kdb.it.budget.project.entity.Bitemm.builder()
    ...
    public String updateProject(String prjMngNo, ProjectDto.UpdateRequest request) {
        ...
        if (request.getItems() != null) {
            // 1. 기존 품목 조회 (DEL_YN='N')
            List<com.kdb.it.budget.project.entity.Bitemm> existingItems = bitemmRepository
            ...
            int maxGclSno = existingItems.stream()
                    .mapToInt(com.kdb.it.budget.project.entity.Bitemm::getGclSno)
                    .max().orElse(0);
            ...
            for (ProjectDto.BitemmDto itemDto : request.getItems()) {
                if (itemDto.getGclMngNo() != null && !itemDto.getGclMngNo().isEmpty()) {
                    ...
                    com.kdb.it.budget.project.entity.Bitemm existingItem = existingItems.stream()
                    ...
                    if (existingItem != null) {
                        ...
                        com.kdb.it.budget.project.entity.Bitemm updatedItem = com.kdb.it.budget.project.entity.Bitemm.builder()
            ...
            for (com.kdb.it.budget.project.entity.Bitemm existingItem : existingItems) {
     ...
     *
     * <p>
     * 프로젝트와 연결된 품목({@link com.kdb.it.budget.project.entity.Bitemm}) 모두를
    ...
    public void deleteProject(String prjMngNo) {
        ...
        List<com.kdb.it.budget.project.entity.Bitemm> bitemms = bitemmRepository.findByPrjMngNoAndPrjSno(prjMngNo,
                project.getPrjSno());
        for (com.kdb.it.budget.project.entity.Bitemm bitemm : bitemms) {
    ...
    private void setBudgetSummary(ProjectDto.Response response, String prjMngNo, Integer prjSno) {
        // 삭제되지 않은 품목 목록 조회
        List<com.kdb.it.budget.project.entity.Bitemm> bitemms = bitemmRepository
    ...
    private void setBudgetSummaryFromItems(ProjectDto.Response response,
            List<com.kdb.it.budget.project.entity.Bitemm> bitemms) {
        // 자본예산 대상 품목구분
