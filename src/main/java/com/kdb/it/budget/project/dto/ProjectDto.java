package com.kdb.it.budget.project.dto;
...
public class ProjectDto {
     ...
     * {@link com.kdb.it.budget.project.service.ProjectService#updateProject}에서 처리합니다.
     * </p>
     */
    @Getter
    @Setter
     ...
     * {@link com.kdb.it.budget.project.entity.Bitemm} 엔티티와 매핑됩니다.
     * </p>
     *
     * <p>
     * 수정 시 동작:
    ...
    public static class BitemmDto {
        ...
        /**
         * {@link com.kdb.it.budget.project.entity.Bitemm} 엔티티를 DTO로 변환하는 정적 팩토리 메서드
         *
         * @param bitemm 변환할 Bitemm 엔티티
         * @return 변환된 BitemmDto
         */
        public static BitemmDto fromEntity(com.kdb.it.budget.project.entity.Bitemm bitemm) {
