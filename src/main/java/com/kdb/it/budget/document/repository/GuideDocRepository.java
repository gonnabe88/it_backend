package com.kdb.it.budget.document.repository;

import com.kdb.it.budget.document.entity.Bgdocm;
...
public interface GuideDocRepository extends JpaRepository<Bgdocm, String> {
     ...
     * </p>
     *
     * @return Oracle 시퀀스(S_GDOC)의 다음 값
     */
    @Query(value = "SELECT S_GDOC.NEXTVAL FROM DUAL", nativeQuery = true)
