 ...
 * 커스텀 인터페이스입니다. {@link BcostmRepositoryImpl}에서 QueryDSL로 구현됩니다.</p>
 *
 * <p>사용 패턴: {@link BcostmRepository}가 이 인터페이스를 상속하므로,
 * {@code bcostmRepository.searchByCondition(condition)}과 같이 직접 사용 가능합니다.</p>
 */
public interface BcostmRepositoryCustom {
     ...
     * </ul>
     *
     * <p>구현: {@link BcostmRepositoryImpl#searchByCondition(CostDto.SearchCondition)}</p>
     *
